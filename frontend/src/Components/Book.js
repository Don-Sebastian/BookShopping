...
function Book() {
  return (
    ...
    //           <p className="info_name">p1</p>
    //           <p className="info_description">
    //               Lorem ipsum dolor, sit amet consectetur adipisicing elit. Tempore ratione fugiat ea nulla accusamus, optio voluptatibus, saepe vel itaque necessitatibus distinctio odit culpa temporibus incidunt aperiam ipsa illum fugit at?
    //           </p>
    //           <p>921</p>
    //         <Link to={`/product/${123}`}><span>view hekki</span></Link>
    //       </div>
